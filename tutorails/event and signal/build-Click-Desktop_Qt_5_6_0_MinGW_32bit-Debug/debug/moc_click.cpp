/****************************************************************************
** Meta object code from reading C++ file 'click.h'
**
...
#error "The header file 'click.h' doesn't include <QObject>."
...
const QMetaObject Click::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Click.data,
      qt_meta_data_Click,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Click::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Click.stringdata0))
        return static_cast<void*>(const_cast< Click*>(this));
