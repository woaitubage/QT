...
const QMetaObject Review::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Review.data,
      qt_meta_data_Review,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Review::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Review.stringdata0))
        return static_cast<void*>(const_cast< Review*>(this));
