...
QT_MOC_LITERAL(1, 9, 22), // "bufferFillCountChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 6), // "cCount"
QT_MOC_LITERAL(4, 40, 20), // "consumerCountChanged"
QT_MOC_LITERAL(5, 61, 5) // "count"

    },
    "consumer\0bufferFillCountChanged\0\0"
    "cCount\0consumerCountChanged\0count"
};
...
void consumer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (consumer::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&consumer::bufferFillCountChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (consumer::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&consumer::consumerCountChanged)) {
                *result = 1;
                return;
            }
        }
