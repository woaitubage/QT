...
QT_MOC_LITERAL(3, 33, 5), // "bCout"
QT_MOC_LITERAL(4, 39, 20), // "producerCountChanged"
QT_MOC_LITERAL(5, 60, 5) // "count"

    },
    "Producer\0bufferFillCountChanged\0\0bCout\0"
    "producerCountChanged\0count"
};
...
void Producer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Producer::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Producer::bufferFillCountChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Producer::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Producer::producerCountChanged)) {
                *result = 1;
                return;
            }
        }
